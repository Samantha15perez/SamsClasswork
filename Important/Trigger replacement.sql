...
go
CREATE TRIGGER TRG_FK_Leads_Companies
on Leads
AFTER INSERT,UPDATE,DELETE
AS
BEGIN
print '**put complicated script here**'
END
go


CREATE TRIGGER TRG_FK_Leads_Contacts
on Leads
AFTER INSERT,UPDATE,DELETE
AS
BEGIN
...
CREATE TRIGGER TRG_FK_Leads_Sources
on Leads
AFTER INSERT,UPDATE,DELETE
AS
BEGIN
...
CREATE TRIGGER TRG_FK_Leads_Agencyid
on Leads
AFTER INSERT,UPDATE,DELETE
AS
BEGIN
